          ...
          <div className="pt-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex flex-wrap gap-2">
                {exp.tech.map((t, i) => (
                  <span key={i} className="text-[9px] font-mono text-amber-500/60 border border-amber-500/10 px-2 py-0.5 rounded uppercase">
                    {t}
                  </span>
                ))}
              </div>
              {exp.externalLinks?.map((link, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[10px] font-mono text-amber-500 hover:text-white bg-amber-500/10 hover:bg-amber-500 border border-amber-500/20 px-3 py-1.5 rounded-sm transition-all"
                >
                  ACCESS_REPORT -&gt;
                </a>
              ))}
