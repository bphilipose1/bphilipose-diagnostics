  ...
  const researchData = [
    {
      ...
      description:
        "Designed a Community-Aware Transformer (CAT) and GCN to model brain connectivity. Optimized training with CUDA to handle high-dimensional neuroimaging datasets.",
    ...
    },
    {
      ...
      description:
        "Developed a low-latency data transfer tool in C++ for autonomous vehicle simulations. Integrated NS-3 and ROS2 for real-time data exchange.",
